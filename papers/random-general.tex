...
\end{equation}
where $\psi(x)$ is the function defined by the LHS of \eqref{homogeneous-general}. \red{Assuming all $M_i < 0$}, the domain \eqref{eq: domain} containing the eigenvalues of $J^*$ first touches the right half-plane at $\zeta = 0$, 
...
Straightforward results follow from condition \eqref{eq: random-stability}.
