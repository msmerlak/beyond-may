...
\begin{figure}[t!]
    ...
    Here we show results from the numerical resolution of the dynamical system~\eqref{dynamics}. Stability is defined as full stable coexistence. The red line is computed using DMFT and the generalized stability condition $N\langle (\sigma/\psi)^2\rangle < 1$.
...
In this letter, we have shown that the condition $\sigma\sqrt{N}< \mu_s - \mu$ does not provide a complete picture of the relationship between complexity and stability. 
