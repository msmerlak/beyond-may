...
In this case the system is always feasible (see Ref.~\cite{Hatton2024} for a discussion on the inclusion of extinction thresholds at low density in an ecological setting) and the distribution can be normalized. However, the first and second moments formally diverge.
