...
\end{equation}
defined from $0$  to $\infty$, and where the expectation values must be computed self-consistently (see~\cite{Hatton2024} for a discussion on feasibility for systems described by this kind of distributions). 
